...
tf.app.flags.DEFINE_string('fold_dir', 'data/test',
                           'Fold directory')

tf.app.flags.DEFINE_string('data_dir', 'data/test',
                           'Data directory')
...
tf.app.flags.DEFINE_string('train_list', 'age_train.txt',
                           'Training list')
tf.app.flags.DEFINE_string('valid_list', 'test.txt',
                           'Test list')
...
class ImageCoder(object):
    ...
    def __init__(self):
        ...
        self._recoded = tf.image.encode_jpeg(cropped, format='grayscale', quality=100)
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
    ...
    for s in xrange(num_shards_per_batch):
        ...
        for i in files_in_shard:
            ...
            example = _convert_to_example(filename, image_buffer, label,1, 1)
            ...
            #     array = np.array(image)
            #
            #     image_buffer = image_data.tostring()
...
def main(unused_argv):
    ...
    # images, labels, _ = distorted_inputs('output', 5, 28, 4)
